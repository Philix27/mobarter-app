...
type iRoutes interface {
	...
	sendPhoneOtp(c *fiber.Ctx) error
	sendEmailOtp(c *fiber.Ctx) error
	nin(c *fiber.Ctx) error
	bvn(c *fiber.Ctx) error
}
...
type BvnInput struct {
	Bvn    string `json:"bvn"`
	UserId string `json:"user_id"`
}

// bvn implements iRoutes.
func (r *Routes) bvn(c *fiber.Ctx) error {
	input := &BvnInput{}
	...
	// ! store upload
	// if err := r.repository.Create(BvnInput{
	// 	Email:     input.Email,
	// 	FirstName: input.FirstName,
	// 	LastName:  input.LastName,
	// }); err != nil {
...
// nin implements iRoutes.
func (r *Routes) nin(c *fiber.Ctx) error {
	panic("unimplemented")
}

// sendEmailOtp implements iRoutes.
func (r *Routes) sendEmailOtp(c *fiber.Ctx) error {
	panic("unimplemented")
}

// sendPhoneOtp implements iRoutes.
func (r *Routes) sendPhoneOtp(c *fiber.Ctx) error {
	panic("unimplemented")
}
